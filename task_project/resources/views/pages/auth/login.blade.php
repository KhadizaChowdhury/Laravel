  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <div>
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
            <a href="{{url('/otp-send')}}"  class="font-semibold text-indigo-600 hover:text-indigo-500">Forgot password?</a>
          </div>
        </div>
        <div class="mt-2">
    ...
    <p class="mt-10 text-center text-sm text-gray-500">
      Not a member?
      <a href="{{url('/user-reg')}}" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Start a 14 day free trial</a>
    </p>
  </div>
</div>
