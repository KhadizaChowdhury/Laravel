    ...
    <div class="row mt-lg-n10 mt-md-n11 mt-n10">
        ...
        <div class="card z-index-0">
            ...
            <form role="form text-left">
                <div class="row mb-3">
                    <div class="col">
                        <input id="firstName" type="text" name="first-name" autocomplete="given-name" class="form-control" placeholder="First name" aria-label="First name">
                    </div>
                    <div class="col">
                        <input  id="lastName" type="text" name="last-name" autocomplete="family-name"  class="form-control" placeholder="Last name" aria-label="Last name">
                    </div>
                </div>
                <div class="mb-3">
                    <input id="mobile" type="text" name="mobile" autocomplete="mobile" class="form-control" placeholder="Mobile" aria-label="mobile" aria-describedby="mobile-addon">
                </div>
                <div class="mb-3">
                ...
                <button onclick="UserRegistration()" type="button" class="btn bg-gradient-dark w-100 my-4 mb-2">Sign up</button>
                </div>
