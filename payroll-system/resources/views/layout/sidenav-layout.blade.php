...
<html lang="en">
  <head>
    ...
    <!-- vendor css -->
    @include('includes.dashboard.css')
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <div id="loader" class="d-none w-full h-full fixed block top-0 left-0 bg-white opacity-75 z-50">
  ...
  @include('includes.dashboard.toastify')
</body>
