        ...
        <div class="w-full">
            <div class="p-8 border-b border-gray-200 shadow">
                <table class="divide-y divide-gray-300" id="tableData">
                    ...
                    <tbody id="allExpense" class="bg-white divide-y divide-gray-300">
    ...
    async function Incomes() {
        ...
        try {
          const response = await axios.get(URL);
            ...
            let allExpense = $('#allExpense');

            tableData.DataTable().destroy();
            allExpense.empty();

            // Iterate over the expenses and create HTML elements for each expense
            expenses.forEach(function(expense,index){
              let row =
                `<tr class="text-center whitespace-nowrap">
                    ...
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-500">${expense['amount']}</div>
                    </td>
                    <td class="px-6 py-4">
